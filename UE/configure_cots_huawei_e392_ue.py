...
def reset_ue():
  stringIdBandrich='Huawei Technologies Co., Ltd. Modem/Networkcard'
  status, out = commands.getstatusoutput('lsusb | grep -i \'' + stringIdBandrich + '\'')
  if (out == '') :
     print "Huawei E392 LTE Adapter not found. Exiting now..."
     sys.exit()
  ...
  print "Huawei E392 LTE Adapter found in..." + usb_dir
